...
hdfs dfs -setfacl -R -m user:nifi:rwx /data     # 3) set ACL rwx permissions for nifi user
hdfs dfs -setfacl -R -m user:dr.who:rwx /data   # 4) set ACL rwx permissions for webUI user
